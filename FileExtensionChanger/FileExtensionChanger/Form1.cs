...
namespace FileExtensionChanger
{
    public partial class Form1 : Form
    {
        ...
        private PictureBox picDragDrop;
        ...
        private void InitializeExtensions()
        {
            ...
            // Populate FlowLayoutPanel with popular extensions
        ...
        private void InitializeComponent()
        {
            ...
            this.picDragDrop = new PictureBox();
            ...
            this.dragDropPanel.Controls.Add(this.picDragDrop);
            ...
            // picDragDrop
            this.picDragDrop.Image = SystemIcons.Information.ToBitmap();
            this.picDragDrop.Location = new Point(260, 25);
            this.picDragDrop.Name = "picDragDrop";
            this.picDragDrop.Size = new Size(70, 70);
            this.picDragDrop.SizeMode = PictureBoxSizeMode.Zoom;
        ...
        private void ApplyModernStyle()
        {
            ...
            // FlowLayoutPanel for extension buttons
        ...
        private void SetupDragDrop()
        {
            ...
            picDragDrop.Click += new EventHandler(DragDropPanel_Click);
        }
        ...
        private void ProcessSelectedFile(string filePath)
        {
            try
            {
                if (File.Exists(filePath))
                {
                    ...
                    // Set corresponding item in ComboBox
        ...
        private void UpdateFileIcon(string extension)
        {
            ...
            picDragDrop.Image = SystemIcons.Application.ToBitmap();
        }
        ...
        private void btnRename_Click(object sender, EventArgs e)
        {
            ...
            {
                // Use selected extension from list
        ...
        private void btnReset_Click(object sender, EventArgs e)
        {
            ...
            cmbExtensions.SelectedIndex = 0;
            picDragDrop.Image = SystemIcons.Information.ToBitmap();
        }

        private void txtCustomExt_KeyPress(object sender, KeyPressEventArgs e)
        {
            // Allow only letters, digits, dot and control characters
        ...
        {
            // Clear custom extension field when selecting from list
            if (!string.IsNullOrEmpty(txtCustomExt.Text))
            {
                txtCustomExt.Clear();
            }
